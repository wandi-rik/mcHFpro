...
__attribute__((section(".layer0_fb0"))) __attribute__ ((aligned (32))) static U8 layer0_fb0[FRAMEBUFFER_SIZE];
//
#if (NUM_BUFFERS > 1)
__attribute__((section(".layer0_fb1"))) __attribute__ ((aligned (32))) static U8 layer0_fb1[FRAMEBUFFER_SIZE];
#endif
//
#if (NUM_BUFFERS > 2)
__attribute__((section(".layer0_fb2"))) __attribute__ ((aligned (32))) static U8 layer0_fb2[FRAMEBUFFER_SIZE];
#endif
//
#if GUI_NUM_LAYERS > 1
__attribute__((section(".layer1_fb0"))) __attribute__ ((aligned (32))) static U8 layer1_fb0[FRAMEBUFFER_SIZE];
#if (NUM_BUFFERS > 1)
__attribute__((section(".layer1_fb1"))) __attribute__ ((aligned (32))) static U8 layer1_fb1[FRAMEBUFFER_SIZE];
#endif
//
#if (NUM_BUFFERS > 2)
__attribute__((section(".layer1_fb2"))) __attribute__ ((aligned (32))) static U8 layer1_fb2[FRAMEBUFFER_SIZE];
#endif
#endif /* GUI_NUM_LAYERS */
...
#define SEM_WAIT	1000	//osWaitForever
...
//
// ToDo: Check why the original example driver
//       doesn't catch this call!
//
#if 1
...
static void _DMA2D_ExecOperation(void)
{
  ...
  if (osSemaphoreWait(osDma2dSemph, SEM_WAIT /* 1000 */) == osErrorOS) {
    /* Semaphore timed out */
    Error_Handler(17);
  }
}
...
void LCD_X_Config(void)
{
  ...
  osSemaphoreWait(LcdUpdateSemaphoreId , SEM_WAIT);

  /* Create the Semaphore used by the two threads */
  /* Create Semaphore lock */
  osSemaphoreDef(Semaphore);
  osDma2dSemph = osSemaphoreCreate(osSemaphore(Semaphore), 1);
  osSemaphoreWait(osDma2dSemph, SEM_WAIT); /* next call to osSemaphoreWait will block */
  ...
  // v 5.40 - crashes the lib
  //LCD_SetVRAMAddrEx(0, (void *)&Framebuffers[0]);
