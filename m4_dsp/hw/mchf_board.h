...
{
	float	rx_filt_q[128];
	ushort	rx_q_num_taps;
	ulong	rx_q_block_size;
	float	rx_filt_i[128];
	ushort	rx_i_num_taps;
	ulong	rx_i_block_size;
	//
	float	tx_filt_q[128];
	ushort	tx_q_num_taps;
	ulong	tx_q_block_size;
	float	tx_filt_i[128];
	ushort	tx_i_num_taps;
